...
contract('TestIndexedEnumerableSetLib', function (accounts) {
  ...
  it('test add, last', (done) => {
    testInstance.add('A').then((_tx) => {
      ++size
      testInstance.last.call().then((_last) => assert.equal(toAscii(_last), 'A'))
    })
    testInstance.add('B').then((_tx) => {
      ++size
      testInstance.last.call().then((_last) => assert.equal(toAscii(_last), 'B'))
    })
    testInstance.add('C').then((_tx) => {
      ++size
      testInstance.last.call().then((_last) => assert.equal(toAscii(_last), 'C'))
    })
    testInstance.add('D').then((_tx) => {
      ++size
      testInstance.last.call().then((_last) => assert.equal(toAscii(_last), 'D'))
    })
    testInstance.add('E').then((_tx) => {
      ++size
  ...
  it('test remove, first', (done) => {
    testInstance.size.call().then((_size) => {
      testInstance.first.call().then((_first) => assert.equal(toAscii(_first), 'A'))
      assert.equal(_size, size)
    })
    testInstance.remove('A').then((_tx) => {
      --size
  ...
  it('test add, remove, contains', (done) => {
    testInstance.add('F').then((_tx) => {
      ++size
      testInstance.contains.call('F').then((_bool) => assert.equal(_bool, true))
    })
    testInstance.add('G').then((_tx) => {
      ++size
      testInstance.contains.call('G').then((_bool) => assert.equal(_bool, true))
    })
    testInstance.add('H').then((_tx) => {
      ++size
      testInstance.contains.call('H').then((_bool) => assert.equal(_bool, true))
    })
    testInstance.add('I').then((_tx) => {
      ++size
      testInstance.contains.call('I').then((_bool) => assert.equal(_bool, true))
    })
    testInstance.add('J').then((_tx) => {
      ++size
      testInstance.contains.call('J').then((_bool) => assert.equal(_bool, true))
    })
    testInstance.remove('J').then((_tx) => {
      --size
      testInstance.contains.call('J').then((_bool) => assert.equal(_bool, false))
    })
    testInstance.remove('I').then((_tx) => {
      --size
      testInstance.contains.call('I').then((_bool) => assert.equal(_bool, false))
    })
    testInstance.remove('H').then((_tx) => {
      --size
